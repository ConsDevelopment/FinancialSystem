...
//using FinancialSystem.Models.Components;
...
using System.Web;
//using static FinancialSystem.Utilities.SelectExistingOrCreateUtility;

namespace FinancialSystem.Utilities.DataTypes {
	[DataContract]
